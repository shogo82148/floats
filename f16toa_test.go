...
func TestFloat16_Text(t *testing.T) {
	tests := []struct {
		...
		{exact16(0x1p-24), 'e', -1, "5.96e-08"},
		{exact16(0x2p-24), 'e', -1, "1.192e-07"},
		{exact16(0x3p-24), 'e', -1, "1.788e-07"},
		{exact16(0x4p-24), 'e', -1, "2.384e-07"},
		{exact16(0x5p-24), 'e', -1, "2.98e-07"},
		{exact16(0x6p-24), 'e', -1, "3.576e-07"},
		{exact16(0x7p-24), 'e', -1, "4.172e-07"},
		{exact16(0x8p-24), 'e', -1, "4.77e-07"},
		{exact16(0x9p-24), 'e', -1, "5.364e-07"},
		{exact16(0xap-24), 'e', -1, "5.96e-07"},
		...
		{exact16(0x1p-15), 'g', -1, "3.052e-05"},
		{exact16(0x1p-16), 'g', -1, "1.526e-05"},
		{exact16(0x1p-17), 'g', -1, "7.63e-06"},
		{exact16(0x1p-18), 'g', -1, "3.815e-06"},
		{exact16(0x1p-19), 'g', -1, "1.907e-06"},
		{exact16(0x1p-20), 'g', -1, "9.54e-07"},
		{exact16(0x1p-21), 'g', -1, "4.77e-07"},
		{exact16(0x1p-22), 'g', -1, "2.384e-07"},
		{exact16(0x1p-23), 'g', -1, "1.192e-07"},
		{exact16(0x1p-24), 'g', -1, "5.96e-08"},
