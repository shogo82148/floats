...
func TestFloat256_Float64(t *testing.T) {
	tests := []struct {
		...
		// test rounding to nearest even
		{
			...
			want: 0x1.0000000000000p+00,
		},
		{
			// 0x1.00000000000008000000000000000000000000000000000000000000001p+00
			in: Float256{
				0x3fff_f000_0000_0000,
				0x0080_0000_0000_0000,
				0x0000_0000_0000_0000,
		...
		{
			// 0x1.00000000000017fffffffffffffffffffffffffffffffffffffffffffffp+00
			in: Float256{
				0x3fff_f000_0000_0000,
				0x017f_ffff_ffff_ffff,
				0xffff_ffff_ffff_ffff,
				0xffff_ffff_ffff_ffff,
			},
			want: 0x1.0000000000001p+00,
		...
		{
			// 0x1.00000000000018p+00
			in: Float256{
				0x3fff_f000_0000_0000,
				0x0180_0000_0000_0000,
				0x0000_0000_0000_0000,
				0x0000_0000_0000_0000,
			},
			want: 0x1.0000000000002p+00,
		...
		// overflow
		{
			...
			want: 0x1.fffffffffffffp+1023, // largest normal number
		},
		{
			in: Float256{
				0x403f_efff_ffff_ffff,
	...
	for _, tt := range tests {
		if got := tt.in.Float64(); !eq64(got, tt.want) {
			t.Errorf("Float256(%x).Float64() = %x, want %x", tt.in, got, tt.want)
		}
	}
}

func BenchmarkFloat256_Float64(b *testing.B) {
	f := Float256{
		0x3fff_f000_0000_0000,
		0x0000_0000_0000_0000,
		0x0000_0000_0000_0000,
...
func TestFloat256_Float128(t *testing.T) {
	tests := []struct {
		...
		{
			// 0x1.00000000000000000000000000017ffffffffffffffffffffffffffffffp+00
			in: Float256{
				0x3fff_f000_0000_0000,
				0x0000_0000_0000_0000,
				0x17ff_ffff_ffff_ffff,
				0xffff_ffff_ffff_ffff,
			},
			want: Float128{
				0x3fff_0000_0000_0000,
		...
		{
			// 0x1.0000000000000000000000000001p-16383
			in: Float256{
			...
			// 0x1.0000000000000000000000000000p-16383
			want: Float128{
		...
		{
			// 0x1.00000000000000000000000000010000000000000000000000000000001p-16383
			in: Float256{
				0x3c00_0000_0000_0000,
				0x0000_0000_0000_0000,
				0x1000_0000_0000_0000,
			...
			// 0x1.0000000000000000000000000002p-16383
			want: Float128{
				0x0000_8000_0000_0000,
				0x0000_0000_0000_0001,
			},
		...
		{
			// 0x1.0000000000000000000000000002fffffffffffffffffffffffffffffffp-16383
			in: Float256{
				0x3c00_0000_0000_0000,
				0x0000_0000_0000_0000,
				0x2fff_ffff_ffff_ffff,
				0xffff_ffff_ffff_ffff,
			},
			// 0x1.0000000000000000000000000002p-16383
			want: Float128{
		...
		{
			// 0x1.0000000000000000000000000003p-16383
			in: Float256{
				0x3c00_0000_0000_0000,
				0x0000_0000_0000_0000,
			...
			// 0x1.0000000000000000000000000004p-16383
			want: Float128{
				0x0000_8000_0000_0000,
				0x0000_0000_0000_0002,
			},
	...
	for _, tt := range tests {
		if got := tt.in.Float128(); !eq128(got, tt.want) {
			t.Errorf("Float256(%x).Float128() = %x, want %x", tt.in, got, tt.want)
		}
	}
}
