...
func TestFloat64_Tanh(t *testing.T) {
	tests := []struct {
		...
		{exact64(0), math.Tanh(0)},
		{exact64(1), math.Tanh(1)},
		{exact64(2), math.Tanh(2)},
		{exact64(3), math.Tanh(3)},
		{exact64(4), math.Tanh(4)},
		{exact64(11), math.Tanh(11)},
	}
...
func BenchmarkFloat64_Tanh(b *testing.B) {
	x := exact64(1.5)
	for b.Loop() {
