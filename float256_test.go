...
func TestFloat256_Int128(t *testing.T) {
	tests := []struct {
		...
		{exact256(0), ints.Int128{0, 0}},
		{exact256(1), ints.Int128{0, 1}},
		{exact256(0.5), ints.Int128{0, 0}},
		{exact256(1 << 63), ints.Int128{0, 1 << 63}},
		{exact256(1 << 127), ints.Int128{1 << (127 - 64), 0}},
		{exact256(-1), ints.Int128{0xffff_ffff_ffff_ffff, 0xffff_ffff_ffff_ffff}},
	}

	for _, tt := range tests {
		got := tt.in.Int128()
		if got != tt.out {
			t.Errorf("Float256(%v).Int128() = %v, want %v", tt.in, got, tt.out)
		}
	}
}
...
func TestFloat256_Uint128(t *testing.T) {
	tests := []struct {
		...
		{exact256(0), ints.Uint128{0, 0}},
		{exact256(1), ints.Uint128{0, 1}},
		{exact256(0.5), ints.Uint128{0, 0}},
		{exact256(1 << 63), ints.Uint128{0, 1 << 63}},
		{exact256(1 << 127), ints.Uint128{1 << 63, 0}},
	}

	for _, tt := range tests {
		got := tt.in.Uint128()
		if got != tt.out {
			t.Errorf("Float256(%v).Uint128() = %v, want %v", tt.in, got, tt.out)
		}
	}
}
...
func TestFloat256_Int256(t *testing.T) {
	tests := []struct {
		...
		{exact256(0), ints.Int256{0, 0, 0, 0}},
		{exact256(1), ints.Int256{0, 0, 0, 1}},
		{exact256(0.5), ints.Int256{0, 0, 0, 0}},
		{exact256(1 << 63), ints.Int256{0, 0, 0, 1 << 63}},
		{exact256(1 << 127), ints.Int256{0, 0, 1 << (127 - 64), 0}},
		{exact256(1 << 128), ints.Int256{0, 1, 0, 0}},
		{exact256(1 << 192), ints.Int256{1, 0, 0, 0}},
		{exact256(1 << 254), ints.Int256{0x4000_0000_0000_0000, 0, 0, 0}},
		{
			exact256(-1),
			ints.Int256{
	...
	for _, tt := range tests {
		got := tt.in.Int256()
		if got != tt.out {
			t.Errorf("Float256(%v).Int256() = %v, want %v", tt.in, got, tt.out)
		}
	}
}
...
func TestFloat256_Uint256(t *testing.T) {
	tests := []struct {
		...
		{exact256(0), ints.Uint256{0, 0, 0, 0}},
		{exact256(1), ints.Uint256{0, 0, 0, 1}},
		{exact256(0.5), ints.Uint256{0, 0, 0, 0}},
		{exact256(1 << 63), ints.Uint256{0, 0, 0, 1 << 63}},
		{exact256(1 << 127), ints.Uint256{0, 0, 1 << 63, 0}},
		{exact256(1 << 128), ints.Uint256{0, 1, 0, 0}},
		{exact256(1 << 192), ints.Uint256{1, 0, 0, 0}},
		{exact256(1 << 255), ints.Uint256{0x8000_0000_0000_0000, 0, 0, 0}},
	}

	for _, tt := range tests {
		got := tt.in.Uint256()
		if got != tt.out {
			t.Errorf("Float256(%v).Uint256() = %v, want %v", tt.in, got, tt.out)
		}
	}
}
