...
Some code has been developed with reference to Go's standard library and [chewxy/math32](https://github.com/chewxy/math32).
Please refer to the [NOTICE](./NOTICE) for the copyright information of these libraries.
